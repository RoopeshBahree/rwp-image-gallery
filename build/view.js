...
const {
  state
} = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.store)('create-block/rwp-image-gallery', {
  ...
  callbacks: {
    expSetupLightbox: () => {
      window.addEventListener('keydown', event => {
        if ('Escape' === event.key) {
          (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_0__.store)('create-block/rwp-image-gallery').actions.closeModal();
        }
      });
    },
    initMasonry: () => {
      ...
      if (gallery) {
        new (masonry_layout__WEBPACK_IMPORTED_MODULE_1___default())(gallery, {
